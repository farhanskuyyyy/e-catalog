                        ...
                        <form method="POST" action="{{ route('products.update', ['product' => $product]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="estimated_time" name="estimated_time"
                                    required value="{{ $product->estimated_time }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="mb-3" id="preview-image">
                                <img src="{{ Storage::url($product->image) }}" alt="" width="400" height="400"
                                    onerror="this.src='https://placehold.co/100x100'">
                            </div>
                            <div class="form-group">
                                <label for="description">Description</label>
                                <textarea class="form-control " name="description" id="description" cols="40" rows="30" style="height: 100px">{{ $product->description }}</textarea>
                            </div>
